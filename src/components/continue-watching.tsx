...
export default function ContinueWatching() {
  ...
  return (
    <div className="relative my-8 max-w-[95rem] mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in z-20">
      {/* Title Header */}
      ...
      <div className="flex overflow-x-auto space-x-4 py-2 no-scrollbar w-full">
        {history.map((item) => {
          ...
          return (
            <div
              key={item.detailPath}
              className="flex-shrink-0 w-[200px] sm:w-[240px] md:w-[270px] relative rounded-2xl overflow-hidden glass-card group flex flex-col transition-all duration-300"
            >
              {/* Card Image Area */}
              ...
              {/* Meta Info Area */}
              <div className="p-3.5 flex flex-col flex-grow bg-glass-panel border-t border-glass-border">
                <Link
                  href={watchUrl}
