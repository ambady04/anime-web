                                      ...
                                      singleStream.downloads.length === 0 ? (
                                        <div className="text-center py-12 space-y-2 border border-dashed border-white/10 rounded-2xl">
                                            ...
                                            .map((link) => {
                                                ...
                                                const activeTask = tasks.find((t) => t.id.startsWith(link.url));
                                                const isDownloading = activeTask?.status === "downloading";
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <button
                                                                ...
                                                                title={isDownloading ? "Downloading..." : isCompleted ? "Download Again" : "Download Now"}
                                                                disabled={isDownloading}
                                                            >
                                                                {isDownloading ? (
                                                                    <>
                                                                        <Loader2 className="w-3.5 h-3.5 animate-spin text-amber-400" />
                                                                        <span>Downloading ({activeTask.progress}%)</span>
                                                                    </>
                                                                ) : isCompleted ? (
                                                                    <>
                                    ...
                                    <div className="flex-1 flex flex-col min-h-0 space-y-4">
                                                ...
                                                >
                                                    {isBulkDownloading ? (
                                                        <>
                                                            ...
                                                            <span>Downloading Season {batchSeason} ({bulkProgress}%)</span>
                                                        </>
                                                    ) : isBulkCompleted ? (
                                                        <>
                                        ...
                                        <div className="flex-1 overflow-y-auto space-y-2 pr-1 no-scrollbar">
                                            {resolvedEpisodes.map((ep, index) => {
                                                ...
                                                const activeTask = tasks.find((t) => t.id.startsWith(ep.url));
                                                const isDownloading = activeTask?.status === "downloading";
                                                const isCompleted = activeTask?.status === "completed";

                                                const isBulkEpDownloading = isBulkDownloading && bulkTask?.currentIdx === index;
                                                const isBulkEpCompleted = isBulkCompleted || (isBulkDownloading && bulkTask && bulkTask.currentIdx !== undefined && bulkTask.currentIdx > index);

                                                const isDownloadingOrBulkDownloading = isDownloading || isBulkEpDownloading;
                                                const isCompletedOrBulkCompleted = isCompleted || isBulkEpCompleted;
                                                        ...
                                                        {ep.success && (
                                                            <div className="flex items-center gap-1.5">
                                                                ...
                                                                <button
                                                                    ...
                                                                    title={isDownloadingOrBulkDownloading ? "Downloading..." : isCompletedOrBulkCompleted ? "Finished" : "Download Episode"}
